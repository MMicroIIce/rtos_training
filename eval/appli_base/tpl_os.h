...
DeclareTask(taskDistance);
DeclareTask(taskMonitoring);
DeclareAlarm(alarmDistance);
DeclareAlarm(alarmMonitoring);
DeclareEvent(evDistance);
DeclareEvent(evFillTank);
DeclareEvent(evFuel);
